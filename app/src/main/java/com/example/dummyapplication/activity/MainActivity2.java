   ...
   *//*
    ...
    protected void showCurrentLocation() {
        ...
        if (location != null) {
            ...
            Toast.makeText(MainActivity2.this, message,
    ...
    private class MyLocationListener implements LocationListener {
        ...
        public void onStatusChanged(String s, int i, Bundle b) {
            Toast.makeText(MainActivity2.this, "Provider status changed",
                    Toast.LENGTH_LONG).show();
        }
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.navigation_new_order:
                    textViewLocation.setText(R.string.title_new_order);
                    return true;
                case R.id.navigation_track_order:
                    textViewLocation.setText(R.string.title_track_order);
                    return true;
                case R.id.navigation_favorites:
                    textViewLocation.setText(R.string.title_favorites);
                    return true;
                case R.id.navigation_catalog:
                    textViewLocation.setText(R.string.title_catalog);
                    return true;
            }
            return false;
        }
